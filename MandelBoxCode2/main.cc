...
void getParameters(char *filename, float *camera_position_array, float *camera_position_changes_array, int frame_no,
 CameraParams *camera_params, RenderParams *renderer_params,
...
int main(int argc, char** argv)
{
  ...
  getParameters(argv[1], camera_position_array, camera_position_changes_array, frame_counter,
  ...
  about_to_crash = renderFractal(camera_params, camera_position_changes_array, frame_counter, renderer_params, image);
